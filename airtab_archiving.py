...
def archive_intakes():
    ...
    for record in records:
        ...
        this_dict["dc_canonical_url"] = record['fields'].get('dc_canonical_url')
        this_dict["PDF"] = record['fields'].get('PDF')
        this_dict["dc_resources_page_image"] = record['fields'].get('dc_resources_page_image')
